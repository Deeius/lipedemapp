...
function BodyOutline({ zones = [], compact = false }) {
  ...
  return (
    <svg width={W} height={H} viewBox="0 0 100 240" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Torso */}
      <path
        d="M32,32 Q50,28 68,32 L70,88 Q50,92 30,88 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="1"
      />
      {/* Upper arms */}
      <path
        d="M14,52 Q8,54 7,68 Q7,80 12,84 Q17,80 18,68 Q18,54 14,52Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
      <path
        d="M86,52 Q92,54 93,68 Q93,80 88,84 Q83,80 82,68 Q82,54 86,52Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
      {/* Forearms */}
      <path
        d="M11,86 Q7,88 6,100 Q6,110 10,112 Q15,110 16,100 Q16,88 11,86Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.7"
      />
      <path
        d="M89,86 Q93,88 94,100 Q94,110 90,112 Q85,110 84,100 Q84,88 89,86Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.7"
      />
      ...
      {/* Hip/pelvis block */}
      <path
        d="M30,88 Q50,92 70,88 L72,126 Q50,132 28,126 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="1"
      />
      {/* Thighs */}
      <path
        d="M28,126 Q34,124 44,124 L44,170 Q36,172 28,168 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.9"
      />
      <path
        d="M72,126 Q66,124 56,124 L56,170 Q64,172 72,168 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.9"
      />
      ...
      {/* Calves */}
      <path
        d="M28,176 Q34,172 44,172 L44,204 Q37,208 28,202 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.9"
      />
      <path
        d="M72,176 Q66,172 56,172 L56,204 Q63,208 72,202 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.9"
      />
      {/* Ankles */}
      <path
        d="M28,202 Q34,206 44,204 L44,214 Q36,216 28,212 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
      <path
        d="M72,202 Q66,206 56,204 L56,214 Q64,216 72,212 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
      {/* Feet */}
      <path
        d="M24,212 Q30,216 44,214 Q46,220 42,222 Q32,222 24,218 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
      <path
        d="M76,212 Q70,216 56,214 Q54,220 58,222 Q68,222 76,218 Z"
        fill={BODY_FILL}
        stroke={BODY_STROKE}
        strokeWidth="0.8"
      />
  ...
  if (type === "bruising")
    return (
      <svg width="72" height="56" viewBox="0 0 72 56" fill="none">
        ...
        />
        {/* Label */}
        <text x="36" y="50" textAnchor="middle" fontSize="7" fill={accent} fontWeight="600">
          hematoma espontáneo
        </text>
      </svg>
    );
  ...
  if (type === "cuffing")
    return (
      <svg width="72" height="80" viewBox="0 0 72 80" fill="none">
        {/* Leg outline */}
        <path
          d="M22,4 Q28,4 32,8 L34,54 Q34,62 28,66 Q22,66 18,62 L16,10 Q18,4 22,4Z"
          fill="rgba(168,196,184,0.07)"
          stroke={stroke}
          strokeWidth={sw}
        />
        {/* Normal calf */}
        <path
          d="M16,14 Q22,12 34,16 L34,36 Q22,38 16,36Z"
          fill="rgba(168,196,184,0.1)"
          stroke="none"
        />
        {/* Fat cuff accumulation — swollen area just above ankle */}
        <path
          d="M14,46 Q20,42 36,44 Q38,50 36,56 Q20,58 14,54 Z"
          fill={`${accent}35`}
          stroke={`${accent}80`}
          strokeWidth="1.2"
        />
        ...
        <path
          d="M14,64 Q18,68 32,66 Q34,70 30,72 Q20,72 14,68Z"
          fill="rgba(168,196,184,0.07)"
          stroke={stroke}
          strokeWidth="0.9"
        />
        ...
        <text x="46" y="46" fontSize="7" fill={accent} fontWeight="700">
          cuff
        </text>
        <text x="46" y="55" fontSize="6" fill={stroke}>
          ↑ pie normal
        </text>
      </svg>
    );
    ...
    return (
      <svg width="72" height="56" viewBox="0 0 72 56" fill="none">
        ...
        <line
          ...
          strokeDasharray="3 2"
        />
        <text x="8" y="12" fontSize="6" fill={stroke}>
          piel
        </text>
        ...
        <text x="36" y="51" textAnchor="middle" fontSize="7" fill={accent} fontWeight="600">
          nódulos subcutáneos
        </text>
      </svg>
    );

  if (type === "disproportion")
    return (
      <svg width="80" height="72" viewBox="0 0 80 72" fill="none">
        ...
        <rect
          ...
          strokeWidth={sw}
        />
        <text x="40" y="36" textAnchor="middle" fontSize="6" fill={stroke}>
          talla S
        </text>
        {/* Hip/leg area — much larger */}
        <path
          d="M14,38 Q20,36 40,35 Q60,36 66,38 Q70,50 64,58 Q52,62 40,62 Q28,62 16,58 Q10,50 14,38Z"
          fill={`${accent}22`}
          stroke={`${accent}70`}
          strokeWidth="1.2"
        />
        <text x="40" y="68" textAnchor="middle" fontSize="6" fill={accent} fontWeight="600">
          talla XL–XXL
        </text>
        {/* Size markers */}
  ...
  if (type === "edema")
    return (
      <svg width="72" height="80" viewBox="0 0 72 80" fill="none">
        ...
        <path
          d="M20,4 Q26,4 30,8 L34,48 Q36,58 30,64 Q24,68 18,64 Q12,58 12,48 L14,10 Q16,4 20,4Z"
          fill="rgba(168,196,184,0.07)"
          stroke={stroke}
          strokeWidth={sw}
        />
        ...
        <path
          d="M10,44 Q14,40 36,42 Q40,52 38,62 Q28,70 16,66 Q8,56 10,44Z"
          fill="rgba(77,138,110,0.12)"
          stroke="rgba(77,138,110,0.5)"
          strokeWidth="1"
        />
        {/* Pitting fovea dot */}
        <circle
          ...
          cy="56"
          r="3"
          fill="rgba(168,196,184,0.3)"
          stroke={stroke}
          strokeWidth="0.8"
        />
        <text x="30" y="58" fontSize="6" fill={stroke}>
          fóvea
        </text>
        {/* Water drops */}
        <text x="44" y="34" fontSize="11">
          💧
        </text>
        <text x="50" y="46" fontSize="8">
          💧
        </text>
        <text x="42" y="52" fontSize="7">
          💧
        </text>
      </svg>
    );
  ...
  if (type === "pain")
    return (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
        ...
        <path
          d="M20,20 Q36,16 52,20 Q56,30 54,44 Q36,50 18,44 Q14,30 20,20Z"
          fill="rgba(168,196,184,0.07)"
          stroke={stroke}
          strokeWidth={sw}
        />
        ...
        <text x="36" y="62" textAnchor="middle" fontSize="7" fill={accent} fontWeight="600">
...
const CONTENT = {
  es: {
    ...
    hero: {
      ...
      intro:
        "El lipedema es una enfermedad crónica del tejido graso que afecta casi exclusivamente a mujeres. Se caracteriza por una acumulación anormal y simétrica de grasa en extremidades que no responde a dieta ni ejercicio, acompañada de dolor, inflamación y fragilidad capilar.",
      facts: [
    ...
    types: {
      ...
      list: [
        {
          num: "1",
          label: "Tipo 1 — Glúteos y caderas",
          zones: ["hips", "buttocks"],
          desc: "La grasa se acumula en glúteos y caderas. Las piernas y el tronco tienen proporciones normales.",
        },
        {
          num: "2",
          label: "Tipo 2 — Caderas y muslos",
          zones: ["hips", "thighs", "buttocks"],
          desc: "Afecta desde la cadera hasta la rodilla, incluyendo cara interna del muslo con pliegues adiposos.",
        },
        {
          num: "3",
          label: "Tipo 3 — Caderas hasta tobillos",
          zones: ["hips", "thighs", "calves", "buttocks"],
          desc: "La grasa se extiende desde la cadera hasta el tobillo, con mayor volumen en pantorrillas.",
        },
        {
          num: "4",
          label: "Tipo 4 — Brazos",
          zones: ["arms"],
          desc: "Afecta a los brazos (codo hacia arriba). Puede coexistir con cualquier otro tipo.",
        },
        {
          num: "5",
          label: "Tipo 5 — Solo pantorrillas",
          zones: ["calves", "ankles"],
          desc: "Afectación predominante en pantorrillas. Menos frecuente, puede asociarse a lipolinfedema.",
        },
      ],
    },
    stages: {
  ...
  en: {
    ...
    hero: {
      ...
      intro:
        "Lipedema is a chronic fat tissue disease that affects almost exclusively women. It is characterized by an abnormal, symmetrical accumulation of fat in the limbs that does not respond to diet or exercise, accompanied by pain, inflammation and capillary fragility.",
      facts: [
    ...
    types: {
      ...
      list: [
        {
          num: "1",
          label: "Type 1 — Buttocks & hips",
          zones: ["hips", "buttocks"],
          desc: "Fat accumulates in the buttocks and hips. Legs and torso have normal proportions.",
        },
        {
          num: "2",
          label: "Type 2 — Hips & thighs",
          zones: ["hips", "thighs", "buttocks"],
          desc: "Affects from the hip to the knee, including the inner thigh with adipose folds.",
        },
        {
          num: "3",
          label: "Type 3 — Hips to ankles",
          zones: ["hips", "thighs", "calves", "buttocks"],
          desc: "Fat extends from the hip to the ankle, with greater volume in the calves.",
        },
        {
          num: "4",
          label: "Type 4 — Arms",
          zones: ["arms"],
          desc: "Affects the arms (above the elbow). Can coexist with any other type.",
        },
        {
          num: "5",
          label: "Type 5 — Calves only",
          zones: ["calves", "ankles"],
          desc: "Predominantly affects calves. Less common; may be associated with lipolymphedema.",
        },
      ],
    },
    stages: {
...
function SymptomVisual({ type }) {
  ...
  if (type === "cuffing")
    return (
      <svg width="80" height="70" viewBox="0 0 80 70">
        {/* Leg shape */}
        <path
          d="M28 5 Q32 5 35 8 L38 52 Q38 58 32 62 Q26 62 22 58 L22 10 Q24 5 28 5Z"
          fill="#2e3a37"
          opacity="0.7"
        />
        {/* Cuff accumulation */}
        ...
        <text x="52" y="47" fontSize="8" fill="#e8e0d0" fontWeight="600">
          cuff
        </text>
        {/* Foot - normal */}
  ...
  if (type === "edema")
    return (
      <svg width="80" height="70" viewBox="0 0 80 70">
        <path
          d="M28 5 Q33 5 36 9 L40 55 Q40 62 34 65 Q28 65 24 61 L20 12 Q22 5 28 5Z"
          fill="#2e3a37"
          opacity="0.6"
        />
        {/* Swelling overlay */}
        <path
          d="M26 38 Q38 35 40 55 Q40 62 34 65 Q28 65 24 61 L22 38 Q24 36 26 38Z"
          fill="#60a5fa"
          opacity="0.35"
        />
        {/* Droplets */}
        <text x="46" y="42" fontSize="14">
          💧
        </text>
        <text x="52" y="54" fontSize="10">
          💧
        </text>
      </svg>
    );
...
export default function WelcomeGuide({ lang = "es", onEnter, isOverlay = false }) {
      ...
      <div style={{ ...glassStrong, padding: "20px 16px 16px", marginBottom: 20 }}>
        <div style={{ display: "flex", justifyContent: "center", gap: 24, alignItems: "flex-end" }}>
          ...
          <div
            style={{
              width: 1,
              height: 200,
              background: "rgba(77,138,110,0.12)",
              alignSelf: "center",
            }}
          />
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: 10, color: WC.creamMuted, lineHeight: 1.4 }}>
                {lang === "es"
                  ? "Acumulación simétrica en extremidades"
                  : "Symmetrical accumulation in limbs"}
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          style={{
            ...
            marginTop: 14,
            paddingTop: 12,
            borderTop: "1px solid rgba(77,138,110,0.1)",
          }}
        >
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <div
              style={{
                ...
                height: 8,
                borderRadius: 3,
                background: "rgba(77,138,110,0.15)",
                border: "1px solid rgba(168,196,184,0.5)",
              }}
            />
            <span style={{ fontSize: 10, color: WC.creamMuted }}>
              {lang === "es" ? "Tejido normal" : "Normal tissue"}
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <div
              style={{
                ...
                height: 8,
                borderRadius: 3,
                background: "rgba(138,108,58,0.18)",
                border: "1px solid rgba(138,108,58,0.6)",
              }}
            />
            <span style={{ fontSize: 10, color: WC.creamMuted }}>
              {lang === "es" ? "Zona afectada" : "Affected zone"}
            </span>
          </div>
        </div>
      </div>

      <p style={{ fontSize: 13, color: WC.creamMuted, lineHeight: 1.75, marginBottom: 18 }}>
        {c.hero.intro}
      </p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
        {c.hero.facts.map((f, i) => (
          ...
          >
            ...
            <span style={{ fontSize: 12, color: WC.cream, fontWeight: 500, lineHeight: 1.4 }}>
              {f.text}
            </span>
          </div>
        ))}
  ...
  const renderTypes = () => (
    <>
      ...
      <div
        style={{ ...glassStrong, padding: "18px 12px 14px", marginBottom: 20, overflowX: "auto" }}
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <div
              style={{
                ...
                borderRadius: 2,
                background: "rgba(77,138,110,0.15)",
                border: "1px solid rgba(77,138,110,0.35)",
              }}
            />
            <span style={{ fontSize: 10, color: WC.creamMuted }}>
      ...
      {c.types.list.map((tp) => (
        <div
          ...
          style={{
            ...
            padding: "14px 16px",
            marginBottom: 10,
            borderLeft: "3px solid rgba(138,108,58,0.6)",
          }}
        >
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            <div
              style={{
                ...
                height: 32,
                borderRadius: 10,
                background: "rgba(138,108,58,0.1)",
                border: "1.5px solid rgba(196,154,100,0.4)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontWeight: 900,
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 13, color: WC.cream, marginBottom: 3 }}>
                {tp.label}
              </div>
      ...
      {c.stages.list.map((st, i) => (
        ...
        >
          ...
          >
            <div
              style={{
                ...
                height: 40,
                borderRadius: 12,
                background: `${stageAccents[i]}30`,
                border: `2px solid ${stageAccents[i]}`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontWeight: 900,
                fontSize: 18,
                color: stageAccents[i],
                flexShrink: 0,
              }}
            >
              {st.num}
          ...
          <div style={{ padding: "14px 16px", display: "flex", gap: 14, alignItems: "flex-start" }}>
            <div
              style={{
                background: `${stageAccents[i]}12`,
                border: `1px solid ${stageAccents[i]}30`,
                borderRadius: 12,
                padding: "8px 4px",
                flexShrink: 0,
              }}
            ...
            <div style={{ flex: 1 }}>
              {st.bullets.map((b, j) => (
                <div
                  key={j}
                  style={{ display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 7 }}
                >
                  <div
                    style={{
                      width: 6,
        ...
        {c.symptoms.list.map((s, i) => (
          ...
          >
            ...
            >
              <div
                style={{
                  background: `${symptomAccents[i]}18`,
                  border: `1px solid ${symptomAccents[i]}40`,
                  borderRadius: 12,
                  padding: "6px 8px",
                }}
              >
  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={S.topBar}>
        ...
        <button style={S.skipBtn} onClick={onEnter}>
          {isOverlay ? (lang === "es" ? "← Volver" : "← Back") : c.skip}
        </button>
      </div>
      ...
      {/* Content */}
      <div style={S.content}>{renders[section]?.()}</div>

      {/* Bottom nav */}
      <div style={S.navBar}>
        {section > 0 && (
          <button style={S.btnPrev} onClick={() => setSection((s) => s - 1)}>
            ← Atrás
          </button>
        )}
