    ...
    <div style={{ borderBottom: `1px solid ${C.border}`, overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          ...
          <span style={{
            fontSize: 13, color: C.creamMuted, marginLeft: 4,
      ...
      {isOpen && (
        <div style={{
          ...
          padding: "14px 12px 16px", display: "flex", flexDirection: "column", gap: 12,
        }}>
          {/* Stats row */}
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {[
              ...
              <div key={s.label} style={{
                flex: 1, minWidth: 60, background: "white", borderRadius: 10,
                padding: "8px 10px", border: `1px solid ${C.border}`, textAlign: "center",
              }}>
                <div style={{ fontSize: 9, color: C.creamMuted, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.4px", marginBottom: 3 }}>
                  {s.label}
                </div>
          ...
          {l.water > 0 && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", background: "#eaf4fb", borderRadius: 8, border: "1px solid #a0c4e8" }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: "#305070" }}>
                {l.water} {lang === "es" ? "vasos de agua" : "glasses of water"}{l.water >= 8 && " ✓"}
              </span>
            </div>
          )}
